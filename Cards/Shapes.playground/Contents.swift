...
class MyViewController : UIViewController {
    override func loadView() {
        ...
        //        view.layer
        //            .addSublayer(
        //                CircleShape(size: CGSize(width: 200, height: 150), fillColor: UIColor.gray.cgColor)
        //            )
        //        //        square
        //        view.layer
        //            .addSublayer(
        //                SquareShape(size: CGSize(width: 200, height: 150), fillColor: UIColor.gray.cgColor)
        //            )
        ////        cross
        //        view.layer
        //            .addSublayer(
        //                CrossShape(size: CGSize(width: 200, height: 150), fillColor: UIColor.gray.cgColor)
        //            )
        ////        fill
